...
## a gauge chart for tweets sentiment:
gaugeChart(Value,breaks=c(0,30,70,100))

negativeValue <- (Sentimentscores_tweets$Score[1] + Sentimentscores_tweets$Score[3] + 
                    Sentimentscores_tweets$Score[4] + Sentimentscores_tweets$Score[6] + 
                    Sentimentscores_tweets$Score[9])
